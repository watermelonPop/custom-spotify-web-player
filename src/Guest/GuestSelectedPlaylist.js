...
function GuestSelectedPlaylist({accessToken, selectedPlaylist, setSelectedPlaylist, showDropDown, setSelectedArtistId, setSelectedPanel, setSelectedAlbum, setSearch, debouncedSearchInput}) {

    return (
        <>
        <div className='selectedPlaylistContentOuter'>
                <div className='contentHeader'>
                        <button onClick={()=>setSelectedPlaylist(null)}><FontAwesomeIcon icon={faArrowLeft}></FontAwesomeIcon></button>
...
export default GuestSelectedPlaylist;