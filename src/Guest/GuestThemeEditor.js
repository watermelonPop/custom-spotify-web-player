...
function GuestThemeEditor({selectedEditTheme, themes, setThemes, currentTheme, setSelectedEditTheme, setCurrentTheme, previousTheme}) {
...
export default GuestThemeEditor;