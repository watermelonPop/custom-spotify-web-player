...
function FreeThemeEditor({selectedEditTheme, themes, setThemes, currentTheme, setSelectedEditTheme, setCurrentTheme, previousTheme}) {
...
export default FreeThemeEditor;