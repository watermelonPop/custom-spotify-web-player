...
function FreeAlbumDropdownMenu({accessToken, album, showPlaylistDropDown, setSelectedArtistId, setSelectedPanel, setSelectedAlbum, playlists, setSearch, debouncedSearchInput, user, setPlaylists}) {
        useEffect(() => {
...
export default FreeAlbumDropdownMenu;