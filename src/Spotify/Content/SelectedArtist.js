...
function SelectedArtist({accessToken, selectedArtistId, setSelectedArtistId, setSelectedPanel, setSelectedAlbum, showPlaylistDropDown, playlists, showDropDown, setSearch, debouncedSearchInput, checkIfLiked, checkIfArtistLiked, handleLikeSong, setLikedSongs, likedSongs, handleUnlikeSong, setPlaylists, user, handlePlayTrack, checkIfAlbumLiked, handleFollowAlbum, setSearchResults, handleUnfollowAlbum, setLoading, handleFollowArtist, handleUnfollowArtist}) {
        //setPanel
        //setSelectedAlbum
    ...
    return (
        ...
        <>
                        ...
                        {selectedArtist.topTracks ? selectedArtist.topTracks.map(track => ( // Correctly wrap the map function
                                <div className='songDiv trackClickable' onClick={()=>handlePlayTrack(track)}>
                                        ...
                                        showDropDown(track.id, e);
                                                                                        ...
                                                                                        <SongDropdownMenu accessToken={accessToken} track={track} showPlaylistDropDown={showPlaylistDropDown} setSelectedArtistId={setSelectedArtistId} setSelectedPanel={setSelectedPanel} setSelectedAlbum={setSelectedAlbum} playlists={playlists} setSearch={setSearch} debouncedSearchInput={debouncedSearchInput} setPlaylists={setPlaylists} user={user}/>
                                                                                </div>
                                                                                </div>
                        )): <p></p>}
                        ...
                        {selectedArtist.albums.map(item => (
                                <div className="albumDiv" key={item.id} onClick={async () => {
                                      ...
                                      >
                                        ...
                                        <div className="albumLikeBtn" onClick={async(e)=>{
                                                        await handleToggleLikeAlbum(item, e);
                                                }}>
                                                <button className={item.liked === true ? "trackLiked" : "trackUnliked"}><FontAwesomeIcon icon={faHeart}></FontAwesomeIcon></button>
                                        </div>
                                        <div className="albumMore">
                                                ...
                                                <AlbumDropdownMenu accessToken={accessToken} album={item} showPlaylistDropDown={showPlaylistDropDown} setSelectedArtistId={setSelectedArtistId} setSelectedPanel={setSelectedPanel} setSelectedAlbum={setSelectedAlbum} playlists={playlists} setSearch={setSearch} debouncedSearchInput={debouncedSearchInput}  user={user} setPlaylists={setPlaylists}/>
                                        </div>
                                </div>
                        ))}
                </>
