...
function Search({accessToken, search, debouncedSearch, searchType, showPlaylistDropDown, setSelectedArtistId, setSelectedPanel, setSelectedAlbum, playlists, showDropDown, setSearch, debouncedSearchInput, checkIfLiked, setSearchType, checkIfArtistLiked, checkIfAlbumLiked, handleLikeSong, handleUnlikeSong, handleFollowArtist, handleUnfollowArtist, handleUnfollowAlbum, handleFollowAlbum, setPlaylists, user, handlePlayTrack, setLoading}) {
                ...
                <div className='searchResultsDiv'>
                {
                        searchType === "tracks" ? (
                                ...
                                {searchResults ? searchResults.map((track, idx) => (
                                        <>
                                        <div className='songDiv trackClickable' key={track.id} onClick={()=>handlePlayTrack(track)}>
                                        ...
                                        <>
                                                <div className="albumDiv" key={alb?.id} onClick={async () => {
                                                        ...
                                                        <button onClick={(e) => {
                                                                ...
                                                                <AlbumDropdownMenu accessToken={accessToken} album={alb} showPlaylistDropDown={showPlaylistDropDown} setSelectedArtistId={setSelectedArtistId} setSelectedPanel={setSelectedPanel} setSelectedAlbum={setSelectedAlbum} playlists={playlists} setSearch={setSearch} debouncedSearchInput={debouncedSearchInput}  user={user} setPlaylists={setPlaylists}/>
                                                        </div>
                                                </div>
                                        </>
                                )) : <p></p>}
