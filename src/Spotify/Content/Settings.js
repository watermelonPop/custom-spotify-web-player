...
function Settings({accessToken, themes, currentTheme, setTheme, setCurrentTheme, setThemes, vantaChoice, setVantaChoice, setEffect}) {
    ...
    return (
        ...
        {creatorOpened === false  && selectedEditTheme === null ? (
            ...
            <ThemeEditor selectedEditTheme={selectedEditTheme} themes={themes} setThemes={setThemes} currentTheme={currentTheme} setSelectedEditTheme={setSelectedEditTheme} setCurrentTheme={setCurrentTheme} previousTheme={previousTheme}/>
        ) : (
            <p></p>
        )
        }
