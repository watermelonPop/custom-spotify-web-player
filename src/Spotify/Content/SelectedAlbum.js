...
function SelectedAlbum({accessToken, selectedAlbum, setSelectedAlbum, showPlaylistDropDown, setSelectedArtistId, setSelectedPanel, playlists, showDropDown, setSearch, debouncedSearchInput, checkIfLiked, checkIfAlbumLiked, handleLikeSong, setLikedSongs, likedSongs, setSelectedPlaylist, handleUnlikeSong, setPlaylists, user, handlePlayTrack, setLoading, handleFollowAlbum, handleUnfollowAlbum}) {
